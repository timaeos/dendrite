...
func (s *Database) SelectIgnores(ctx context.Context, userID string) (*types.IgnoredUsers, error) {
	return s.Ignores.SelectIgnores(ctx, userID)
}

func (s *Database) UpsertIgnores(ctx context.Context, userID string, ignores *types.IgnoredUsers) error {
