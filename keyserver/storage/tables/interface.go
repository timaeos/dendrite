...
type CrossSigningSigs interface {
	...
	SelectCrossSigningSigsForOriginTarget(ctx context.Context, txn *sql.Tx, originUserID, targetUserID string, targetKeyID gomatrixserverlib.KeyID) (r types.CrossSigningSigMap, err error)
